...
Assets/Code/
  ...
  Domain/      — модели, интерфейсы (Api/), расширения; asmdef "Base", без зависимостей
    Extensions/ - расширения, использовать в коде, дописывать по аналогии
...
- Если какая-то логика работы с внешним типом безконтекстна и относится скорее к типу, писать её в расширения
